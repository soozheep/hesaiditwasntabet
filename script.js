const SITE_URL = 'https://hesaiditwasntabet.vercel.app';
...
async function sharePage(){if(navigator.share){try{await navigator.share({title:"He Said It Wasn't a Bet — Sonic Remedy | Soozhee",text:"He Said It Wasn't a Bet by Soozhee. Sonic Remedy : Audiosensory Resonance | Trust Your Path.",url:SITE_URL});return}catch(e){}}await navigator.clipboard.writeText(SITE_URL);showToast('Link copied')}
